...
run "$GO_BIN" test ./internal/sri -run 'TestServiceCheckReportsOKAndJSONCompatibility|TestServiceCheckAutoFixAppliesAndTriggersHooks|TestServiceCheckDryRunSkipsAutoFixAndDownstream|TestServiceDetectsSRIProblemsAndHostGuards|TestServiceGuardsAgainstLargeFilesSymlinksAndMalformedInput|TestServiceRejectsScanRootsOutsideHugoRoot' -v
